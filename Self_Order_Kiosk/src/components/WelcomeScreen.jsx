      ...
      <div className="relative z-10 px-8 py-6 flex flex-col items-center gap-6 w-full max-w-lg mx-auto mt-auto mb-4">
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full mt-2">
          ...
          <button
            ...
            className="group relative flex flex-col items-center justify-center p-5 sm:p-6 rounded-[28px] bg-gradient-to-br from-brand-500 to-brand-600 hover:from-brand-400 hover:to-brand-500 border-b-4 border-brand-700 shadow-lg shadow-brand-500/30 active:translate-y-1 active:border-b-0 active:mt-1 touch-press transition-all duration-200"
          >
            ...
            <span className="text-xs sm:text-sm text-brand-100 text-center mt-1.5 font-medium leading-tight">
              {t('dine_in_desc')}
            </span>
